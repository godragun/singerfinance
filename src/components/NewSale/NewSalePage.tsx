...
export const NewSalePage: React.FC = () => {
  ...
  // Custom states to allow editability after autofill
  ...
  // Trigger browser print when printSaleData is set
  useEffect(() => {
    if (printSaleData) {
  ...
  // Handle Model Selection for a row
  ...
  // Handle row field changes (price, rental, name, term)
    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          ...
          {/* Bottom Totals and Term Selection */}
